...
class VibeCodingApp:
    def __init__(self, root):
        ...
        self.root.bind("<Escape>", self.toggle_listening_hotkey)
    ...
    def setup_ui(self):
        ...
        # Hotkey toggle
        self.hotkey_frame = ttk.Frame(main_frame)
        self.hotkey_frame.pack(pady=5)
        
        self.hotkey_var = tk.BooleanVar(value=True)
        self.hotkey_checkbox = ttk.Checkbutton(
            self.hotkey_frame, 
            text="Enable ESC hotkey to toggle listening", 
            variable=self.hotkey_var,
            command=self.update_hotkey_status
        )
        self.hotkey_checkbox.pack()
    ...
    def toggle_listening_hotkey(self, event=None):
    ...
    def recognition_thread(self):
        ...
        while self.is_listening:
            try:
                ...
                if self.is_listening:  # Only show error if not stopping
